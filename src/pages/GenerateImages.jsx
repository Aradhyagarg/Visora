...
const GenerateImages = () => {
  ...
  const ImageStyle = [
    'Realistic', 'Ghibli style', 'Anime style', 'Fantasy style',
    'Realistic style', '3D style', 'Portrait style', 'Cartoon style'
  ];
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      if (data?.success === true) {
        ...
        toast.error(data?.message || "This feature is only for premium users");
        return;
      }
