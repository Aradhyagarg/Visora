...
const Footer = () => {
  return (
    <section class="py-10 sm:pt-16 lg:pt-30">
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            <img class="w-auto h-9" src="/Visora.png" alt="" />

            <p className="text-base leading-relaxed text-gray-600 mt-7">
              Visora empowers creators with AI-driven tools to generate
              articles, blog titles, stunning images, and seamlessly remove
              backgrounds or objects. Transform your content creation workflow
        ...
        <p class="text-sm text-center text-gray-600">
          © Copyright 2021, All Rights Reserved by Visora
        </p>
      </div>
    </section>
  );
